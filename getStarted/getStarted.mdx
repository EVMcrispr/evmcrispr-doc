...
You can title and save scripts into your script library with the save button in the top right corner of the terminal. This will keep your EVMcrispr script saved for later use in your browser's local storage. 

<img id="border" alt="saving scripts on terminal" src={useBaseUrl('img/getStarted/savingScripts.png')} />  

### Sharing 

Any script inside your terminal can be copied and shared via a simple URL. Click the share button near the top right edge of the terminal window, this will upload the script in your terminal to IPFS and and create a unique URL with the IPFS hash of your uploaded script. The full URL is then copied to your clipboard and ready to be shared!

### Loading 

On the right hand side of the terminal screen you can see a tab named `Library`. Clicking this will open up a list of your saved scripts, simply click on a script in your library to load it into the terminal.




:::danger
If you clear or delete your browse's local data storage you will erase all your saved scripts in your script library! If you want to permanently save a script, try clicking the share button and keep a copy of the URL somewhere safe.
:::
